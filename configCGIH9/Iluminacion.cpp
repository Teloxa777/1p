...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glUniform3f(glGetUniformLocation(lightingShader.Program, "light.spectacular"), 0.8f, 0.8f, 0.8f);
        ...
        glUniform3f(glGetUniformLocation(lightingShader.Program, "material.diffuse"), 0.9f, 0.6f, 0.0f);
        glUniform3f(glGetUniformLocation(lightingShader.Program, "material.spectacular"), 1.0f, 0.0f, 0.0f);
       ...
       GLint lightPos2 = glGetUniformLocation(lightingShader.Program, "light.position");
       GLint viewPosLoc2 = glGetUniformLocation(lightingShader.Program, "viewPos");
       glUniform3f(lightPosLoc, lightPos2.x + movelightPos2, lightPos2.y + movelightPos2, lightPos2.z + movelightPos2);
